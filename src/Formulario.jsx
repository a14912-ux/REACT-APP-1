...
function Formulario() {
    ...
    function limparFormulario() {
        setFormData({ nome: '', email: '', telefone: '', morada: '', codigo: '', mensagem: '' });
    ...
    return (
        <div className="mt-4">
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                    <label>Codigo</label>
                    <textarea className="form-control" rows="3" value={formData.codigo} onChange={(e) =>

                        setFormData({ ...formData, codigo: e.target.value })}></textarea>
                </div>
                <div className="form-group">
            ...
            {dadosSubmetidos && (
                <div className="card mt-4">
                    <div className="card-body">
                        ...
                        <p><strong>Codigo:</strong> {dadosSubmetidos.codigo}</p>
